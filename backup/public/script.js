...
function saveSettings() {
    ...
    console.log('scoket is ' + socket.id);
...
function showEditor() {
    ...
    document.getElementById('editor-content').value=getCookie('editor-content');
...
function saveFile() {
    ...
    setCookie('editor-content', content, 1000); // Save content to a cookie for 7 days
